    ...
    return (
        <>
            <div
                onClick={handleClick}
                className={`
          relative p-4 sm:p-3 rounded-xl bg-white border-2 transition-all duration-150
          min-h-[140px] sm:min-h-[120px] w-full
          ${hasStock
        ...
        `}
            >
                ...
                <div className="absolute top-3 right-3">
                    <svg className="w-5 h-5 sm:w-4 sm:h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="mb-3 pr-6">
                    <h3 className="font-medium text-slate-800 text-base sm:text-sm leading-tight line-clamp-2">
                        {product.name}
                    </h3>
                    {product.genericName && (
                ...
                <div className="flex items-center justify-between">
                    <span className="font-bold text-primary-600 text-lg sm:text-base">
                        {formatCurrency(product.price)}
                    </span>

                    {/* Stock indicator */}
                    <span className={`text-xs sm:text-xs px-2 py-1 rounded ${!hasStock
